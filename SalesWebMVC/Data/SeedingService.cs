...
namespace SalesWebMVC.Data
{
    public class SeedingService 
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@mail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Violet", "maria@mail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Green", "alex@mail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@mail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Roswell", "donald@mail.com", new DateTime(2000, 5, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Marco Donato", "marco@mail.com", new DateTime(1997, 3, 4), 3000.0, d2);
            ...
            _context.SalesRecord.AddRange(r1, r2, r3, r4, r5, r6, r6, r8, r9, r10,
